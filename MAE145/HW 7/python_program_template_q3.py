...
def predict(x_t, u_t_plus_1, alpha):
    ...
    u_t_plus_1_err.append(u_t_plus_1[1] - box_muller(0,alpha[2]*(u_t_plus_1[1])**2+alpha[3]*(u_t_plus_1[0])**2)+alpha[3]*(u_t_plus_1[2])**2)
    u_t_plus_1_err.append(u_t_plus_1[2] - box_muller(0,alpha[0]*(u_t_plus_1[0])**2+alpha[1]*(u_t_plus_1[1])**2))
    ...
    x_t_plus_1.append(x_t[0] + u_t_plus_1_err[1]*np.cos(x_t[2]+u_t_plus_1_err[0]))
    
    x_t_plus_1.append(x_t[1] + u_t_plus_1_err[1]*np.sin(x_t[2]+u_t_plus_1_err[0]))
